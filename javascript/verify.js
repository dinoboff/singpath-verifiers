...
/*
// Need to add back in the node execution. 
var result = testSolution('var foo = 1;', "test('foo should be set', function(){ assert.equal(1, foo)})");
 // would return `{solved: true, results:[{test: 'foo should be set', correct: true}]}`
...
// Return a default response initially for container testing. 
var result = "{'printed': '', 'solved': False, 'results': [{'received': '2', 'expected': 2, 'call': 'x', 'correct': True}, {'received': '2', 'expected': 3, 'call': 'y', 'correct': False}]}"
